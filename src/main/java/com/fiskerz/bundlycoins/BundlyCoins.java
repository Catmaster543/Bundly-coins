...
@Mod(BundlyCoins.MODID)
public class BundlyCoins {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "bundlycoins";
    ...
    public BundlyCoins(IEventBus modEventBus, ModContainer modContainer) {
